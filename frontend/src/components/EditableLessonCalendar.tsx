...
interface EditableLessonCalendarProps {
  lessons: Lesson[];
  students: Student[];
...
export function EditableLessonCalendar({
  lessons,
  students,
  onEditLesson,
  onStatusChange,
}: EditableLessonCalendarProps) {
            ...
            >
              ...
              <div className="space-y-1">
                {dayLessons.slice(0, 2).map((lesson) => (
                  <div
                    key={lesson.id}
                    className="text-xs p-1 bg-blue-50 rounded hover:bg-blue-100 transition-colors"
                  >
                    <div className="flex items-center justify-between">
